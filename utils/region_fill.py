...
def formRightSide(I, maskPerimeter):
    ...
    rightSide[1 : height - 1, 0] = (
        perimeterValues[0 : height - 2, 0] + perimeterValues[2:height, 0] + perimeterValues[1 : height - 1, 1]
    )
    ...
    rightSide[0, 1 : width - 1] = (
        perimeterValues[1, 1 : width - 1] + perimeterValues[0, 0 : width - 2] + perimeterValues[0, 2:width]
    )
